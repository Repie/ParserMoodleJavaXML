...
public class CorrectQuestionCreation extends TestCase {
	...
	public void testDescription() throws MalformedQuestionException {
		...
		Description d = new Description("Consigne dispositif électronique",
	...
	public void testEssay() throws MalformedQuestionException {
		...
		answers.add(a);
		Essay q = new Essay("Question ouverte", answers,
				"Ecrire un programme qui affiche Hello world");
		QuizWriter.write(q);
	}
	...
	public void testMultipleChoice() throws MalformedQuestionException {
		...
		MultipleChoice m = new MultipleChoice(
				...
				a, QuestionTextFormat.MOODLE_AUTO_FORMAT, 1, false,
				AnswerNumberingType.ABC, "OK", new String(""), "KO",
				(float) 0.1, 0, 1);
	...
	public void testNumerical() throws MalformedQuestionException {
		...
		Numerical n = new Numerical(
				...
				a, "HTTP 1er protocole de l'Internet");
	...
	public void testTrueFalse() throws MalformedQuestionException {
		ArrayList<RegularAnswer> a = new ArrayList<RegularAnswer>();
		a.add(new RegularAnswer("true", 0,
				"Tomcat est un conteneur Web uniquement."));
		a.add(new RegularAnswer("false", 100,
				"Tomcat est un conteneur Web uniquement."));
		TrueFalse tf = new TrueFalse("Tomcat et JEE", a,
				"omcat est un conteneur implémentant toutes les spécifications JEE.");
		QuizWriter.write(tf);
	}
